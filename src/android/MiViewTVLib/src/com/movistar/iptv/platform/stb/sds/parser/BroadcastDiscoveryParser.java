...
public class BroadcastDiscoveryParser extends ServiceDiscoveryParser {
    ...
    public static BroadcastDiscoveryData parse(DvbStpContent content) throws DiscoveryParserException {

        try {
            return (BroadcastDiscoveryData) new BroadcastDiscoveryParser().parse(content.getByteArrayInputStream());
        } catch (Exception e) {
